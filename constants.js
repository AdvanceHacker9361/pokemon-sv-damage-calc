...
const ITEMS = {
    ...
    'でんきだま': { type: 'none' },
    // タイプ強化アイテム
    'シルクのスカーフ': { type: 'typePower', moveType: 'ノーマル', value: 1.2 },
    'もくたん': { type: 'typePower', moveType: 'ほのお', value: 1.2 },
    'しんぴのしずく': { type: 'typePower', moveType: 'みず', value: 1.2 },
    'じしゃく': { type: 'typePower', moveType: 'でんき', value: 1.2 },
